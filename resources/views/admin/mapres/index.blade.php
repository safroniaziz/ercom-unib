...
@section('main-title','Manajemen Mapres')
@section('manajemen-title','Manajemen Mapres')
@section('manajemen-title-right')
	<a onclick="tambahMapres()" class="btn btn-primary pull-right btn-flat"  style="margin-top: -8px; margin-left: 10px;"><i class="fa fa-plus"></i>&nbsp;Tambah Mapres</a>
