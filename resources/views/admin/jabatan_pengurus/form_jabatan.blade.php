		...
		<div class="modal-content" id="modal-content">
			<form method="post"  id="form" class="form-horizontal" data-toggle="validator">
				...
				<div class="modal-body">
					<input type="hidden" id="id" name="id_jabatan">
					<div class="form-group">
						<label for="jabatan" class="col-md-3 control-label">Jabatan Pengurus :</label>
						<div class="col-md-8">
							<input type="text" name="nm_jabatan" id="nm_jabatan" class="form-control" required="">
						</div>
					</div>
				</div>
