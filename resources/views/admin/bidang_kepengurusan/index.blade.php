...
@section('manajemen-title-right')
	<a onclick="tambahBidang()" class="btn btn-primary pull-right btn-flat"  style="margin-top: -8px; margin-left: 10px;"><i class="fa fa-plus"></i>&nbsp;Tambah Bidang</a>
...
@section('content')
	...
	<div class="row">
			<div class="col-md-12">
			<table class="table table-bordered table-hover table-striped" id="table-bidang" style="width: 100%;">
				<thead>
					<tr>
						<th>No</th>
						<th>Nama Bidang Kepengurusan</th>
						<th>Aksi</th>
					</tr>
				</thead>
			</table>
	...
	@include('admin/bidang_kepengurusan.form_bidang')
@endsection